...
const Work = ({ className }: Props): JSX.Element => {
  ...
  const descriptions = [
    <div key="havas">
      <div>
        <div className="text-lg md:text-2xl font-medium text-slate-700">
          Software Engineer <span className="text-purple-600">@ Havas CX</span>
        </div>
        <div className="mt-1 italic font-sans text-slate-700">May 2021 - Present</div>
      </div>
    ...
    <div key="softtech">
      <div>
        ...
        <div className="mt-1 italic font-sans text-slate-700">September 2020 - October 2020</div>
      </div>
      <hr className="w-1/2 my-2" />
      <ul className="space-y-3 text-slate-700">
        <li>Worked as a full-stack web developer</li>
    ...
    <div key="sociable">
      <div>
        ...
        <div className="mt-1 italic font-sans text-slate-700">January 2019 - April 2019</div>
      </div>
      <hr className="w-1/2 my-2" />
      <ul className="space-y-3 text-slate-700">
  ...
  return (
    <section className={clsx('flex flex-col items-center mt-16', className)}>
      <h1 className="text-4xl font-bold font-sans tracking-wide text-slate-800">
        Where I&apos;ve Worked
      </h1>
