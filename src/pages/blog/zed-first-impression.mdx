...
image: "https://simpleicons.org/icons/zedindustries.svg"
imageAlt: "Zed logo"
publish: false
...
<div className="mx-auto not-prose flex flex-col items-center my-8">
  ...
  <p className="text-sm mt-2">
    Zed editor and Zed logo are trademarks of{" "}
    <a href="https://zed.dev/brand" className="text-accent underline">
      Zed Industries
    </a>
  </p>
</div>
